...
TRANSLATIONS = {
    'pl': {
        ...
        'modifications_section': 'Modyfikacje i Systemy',
        'basic_modifications': 'Podstawowe Modyfikacje',
        'structural_systems': 'Systemy Konstrukcyjne',
        'preview_config': 'Podgląd Konfiguracji',
    ...
    'en': {
        ...
        'modifications_section': 'Modifications & Systems',
        'basic_modifications': 'Basic Modifications',
        'structural_systems': 'Structural Systems',
        'preview_config': 'Configuration Preview',
