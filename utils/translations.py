...
translations = {
    'en': {
        'app_title': 'Steel Container Sales Calculator',
        'app_subtitle': 'AI-Powered Cost Estimation for Container Modifications',
    ...
    'pl': {
        'app_title': 'Kalkulator Sprzedaży Kontenerów Stalowych',
        'app_subtitle': 'Szacowanie Kosztów z Wykorzystaniem AI dla Modyfikacji Kontenerów',
    ...
    'de': {
        'app_title': 'Stahlcontainer Verkaufsrechner',
        'app_subtitle': 'KI-gestützte Kostenschätzung für Container-Modifikationen',
        'navigation': 'Navigation',
    ...
    'nl': {
        'app_title': 'Staalcontainer Verkoopcalculator',
        'app_subtitle': 'AI-aangedreven kostenschatting voor containermodificaties',
