...
TRANSLATIONS = {
    'pl': {
        ...
        # App main page
        'app.title': 'Kalkulator Sprzedaży Kontenerów KAN-BUD',
        'app.subtitle': 'Profesjonalne Rozwiązania Modyfikacji Kontenerów',
    ...
    'en': {
        ...
        # App main page
        'app.title': 'KAN-BUD Container Sales Calculator',
        'app.subtitle': 'Professional Container Modification Solutions',
    ...
    'de': {
        ...
        # App main page
        'app.title': 'KAN-BUD Container-Verkaufsrechner',
        'app.subtitle': 'Professionelle Container-Modifikationslösungen',
    ...
    'nl': {
        ...
        # App main page
        'app.title': 'KAN-BUD Container Verkoopcalculator',
        'app.subtitle': 'Professionele Container Modificatie Oplossingen',
